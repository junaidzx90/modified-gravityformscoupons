		...
		return array(
			...
			array(
				...
				'fields'      => array(
					...
					array(
						'name'    => 'userLimit',
						'label'   => __( 'User Limit', 'gravityformscoupons' ),
						'type'    => 'text',
						'tooltip' => '<h6>' . esc_html__( 'User Limit', 'gravityformscoupons' ) . '</h6>' . esc_html__( 'Enter the number of times coupon code can be used by a single user.', 'gravityformscoupons' ),
					),
					array(
						'name'    => 'isStackable',
